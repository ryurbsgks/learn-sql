...
*/
const PART4_3 = `INSERT INTO user(name, email) VALUES ("ryurbsgks", "ryurbsgks5114@naver.com")`;
...
*/
const PART4_8 = `SELECT content.title, user.name FROM content JOIN user ON content.userId=user.id`;
...
*/
const PART4_10 = `INSERT INTO content(title, body, userId) VALUES("test", "test", 1)`;
